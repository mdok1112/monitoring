        ...
        <div class="row">
            ...
            <div class="col-md-10">
                <div class="pt-3 pb-2 mb-3 border-bottom row justify-content-between">
                    <h1 class="col-sm-3 h3">검증 작업자 코드 관리</h1>
                    <div class="col-sm-2">
                ...
                <div class="">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <th scope="col">순번</th>
                                <th scope="col">작업자 코드</th>
                                <th scope="col">작업자 설명</th>
                                <th scope="col">작업자 LEVEL</th>
                                <th scope="col">접근 가능 업무</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
                                ...
                                <td>관리자</td>
                                <td>0</td>
                                <td>EDMS, NAKS, LPC, EFS, SOS, HPWS</td>
                            </tr>
                            <tr>
                                <th scope="row">002</th>
                                <td>manager</td>
